...
public class SimpleDB {
	...
	public static void main(String[] args) {
			int id1 = 208935791;  // "dummy existing ID  
			int level = 0;
		//	allUsers();
			printLog();
	 ...
	 */
		public static void printLog() {
			try {
				...
				{
					System.out.println("Id: " + resultSet.getInt("UserID")+",tt"+resultSet.getInt("levelID")+","+resultSet.getInt("moves")+","+resultSet.getInt("score"));
				}
				resultSet.close();
				statement.close();		
				connection.close();		
