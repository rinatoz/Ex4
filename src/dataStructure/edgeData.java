...
public class edgeData implements edge_data, Serializable
{
    ...
    static {
        edgeData.DEFAULT_WEIGHT = 1.0;
    }
    
    public edgeData(final int src, final int dest) {
        this(src, dest, edgeData.DEFAULT_WEIGHT);
    }
    
    public edgeData(final int src, final int dest, final double w) {
        this.set_src(src);
        this.set_dest(dest);
        this.set_weight(w);
    }
